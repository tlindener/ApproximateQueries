...
public class ILFrequentItemsApproximate {
    ...
    public static void run(int bound, int websites, int cookies, int top, int emitMin) throws Exception {
        StringBuilder sb = new StringBuilder().append(Constants.ANALYSIS_RESULTS_BASE).append(Constants.ANALYSIS_PATH_IL_FREQUENT_ITEMS_APPROXIMATE).append(Calendar.getInstance().getTime().toString());
        ...
        Queries.continuousTopN(inputStream, valueSelector, top, emitMin).writeAsText(sb.toString() + "/FrequentItems");
