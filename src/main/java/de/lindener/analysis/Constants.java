...
public class Constants {
    public static String ANALYSIS_PATH_IL_FREQUENT_ITEMS_APPROXIMATE = "IL_FI_Approximate/";
    public static String ANALYSIS_PATH_IL_FREQUENT_ITEMS_EXACT = "IL_FI_Exact/";
...
//    public static String ANALYSIS_WT_PATH = "C:\\Users\\tobias\\Desktop\\projects\\queries\\data\\wiki";
    ...
    public static String ANALYSIS_AZ_PATH_P = "/media/data/approximatequeries/books.csv";
    public static String ANALYSIS_WT_PATH = "/media/data/approximatequeries/wiki";
}
